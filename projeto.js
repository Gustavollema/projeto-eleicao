...
const eleitores = new Object ();
 ...
 if (votar == 1) {
   ...
   if ((eleitores.Matheus > eleitores.Giovanna) & (eleitores.Matheus > eleitores.Carini) ) {
  this.Matheus = this.Matheus + 1}
  else if ((eleitores.Giovanna > eleitores.Matheus) & (eleitores.Giovanna > eleitores.Carini) ) {
  this.Giovanna = this.Giovanna + 1
 } else if ((eleitores.Carini > eleitores.Matheus) & (eleitores.Carini > eleitores.Giovanna) ) {
  this.Carini = this.Carini + 1
}}
